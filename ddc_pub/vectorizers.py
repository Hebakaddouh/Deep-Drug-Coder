...
class SmilesVectorizer(object):
    ...
    """
    def __init__(self, charset = '@C)(=cOn1S2/H[N]\\', pad=5, maxlength=400, leftpad=True, isomericSmiles=True, augment=True, canonical=False, startchar = '^', endchar = '$', unknownchar = '?', binary=False):
        #Special Characters
